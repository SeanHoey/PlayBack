...
public class SongManager extends ListActivity{
	final String MEDIA_PATH = "/storage/emulated/0/mobile/music/D/Music/";
	...
	private void addSongToList(File song) {
	    if (song.getName().endsWith(mp3Pattern)) {
	        ...
	        songMap.put("artist", MediaStore.Audio.Media.ARTIST);
