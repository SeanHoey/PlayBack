...
public class CircleRender extends Renderer{
	private Paint mPaint;
	   ...
	   */
	  public CircleRender(Paint paint)
	  {
	    this(paint, false);
	  }
	   ...
	   */
	  public CircleRender(Paint paint, boolean cycleColor)
	  {
	    super();
	    mPaint = paint;
	  ...
	  public void onRender(Canvas canvas, AudioData data, Rect rect)
	  {
	    ...
	    for (int i = 0; i < data.bytes.length - 1; i++) {
	      ...
	      mPoint[i * 4] = polarPoint[0];
	      mPoint[i * 4 + 1] = polarPoint[1];
	      ...
	      mPoint[i * 4 + 2] = polarPoint2[0];
	      mPoint[i * 4 + 3] = polarPoint2[1];
	    }
